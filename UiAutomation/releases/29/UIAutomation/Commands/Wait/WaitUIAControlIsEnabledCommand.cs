...
// ErrorCategory.InvalidArgument,
// this.ControlType));
                UIAHelper.GetDesktopScreenshot(this, CmdletName(this) + "_BadControl", true, 0, 0, 0, 0);
                // 20120209 return;
...
// }
            ...
            do
            {
                ...
                if (!this.CheckControl(this))
                {
                    ...
                    UIAHelper.GetDesktopScreenshot(this, CmdletName(this) + "_NoControl", true, 0, 0, 0, 0);
                    return;
                }
                this.Wait = !(_control.Current).IsEnabled;
                ...
                if (_control == null) {
                    ...
                    UIAHelper.GetDesktopScreenshot(this, CmdletName(this) + "_ControlEqNull", true, 0, 0, 0, 0);
                    WriteError(this, new ErrorRecord(new Exception(),
