...
// bool res2 = SendMessage1(handle, uUp, IntPtr.Zero, lParam);
        ...
        internal bool CheckControl(HasControlInputCmdletBase cmdlet)
        {
            ...
            if (cmdlet.InputObject == null)
            {
                ...
                WriteVerbose(cmdlet, "[checking the control] Control is null");
                if (this.PassThru) {
            ...
            try {
                ...
                WriteDebug(cmdlet, "[checking the control] Control is not an AutomationElement");
                WriteDebug(cmdlet, "[checking the control] " + eControlTypeException.Message);
                if (this.PassThru) {
                    // result = null;
                    //WriteObject(this, null);
...
//WriteVerbose(this, "000003");
                    ...
                    if (key1.ToUpper() == "NAME") {
                        ...
                        name = SearchCriteria[i][key1].ToString();
                    ...
                    if (key1.ToUpper() == "AUTOMATIONID") {
                        ...
                        automationId = SearchCriteria[i][key1].ToString();
...
//WriteVerbose(this, "000010");
                GetControlCmdletBase cmdlet = 
                    new GetControlCmdletBase();
//WriteVerbose(this, "000011");
...
//WriteVerbose(this, "!!!!!! now: cmdlet.InputObject = UIAutomation.CurrentData.CurrentWindow; !!!!!!!!!");
                cmdlet.InputObject = UIAutomation.CurrentData.CurrentWindow;
//try {WriteVerbose(this, "type name= " + cmdlet.InputObject.GetType().Name); } catch {}
//try {WriteVerbose(this, "name= " + cmdlet.InputObject.Current.Name); } catch {}
//try {WriteVerbose(this, "auid= " + cmdlet.InputObject.Current.AutomationId); } catch {}
//try {WriteVerbose(this, "handle= " + cmdlet.InputObject.Current.NativeWindowHandle.ToString()); } catch {}
                //cmdlet._window = //UIAutomation.CurrentData.CurrentWindow;
                // (System.Windows.Automation.AutomationElement)(cmdlet.InputObject);
//WriteVerbose(this, "000012");
...
//WriteVerbose(this, "000015");
                    ...
                    WriteVerbose(this, "couldn't get the control");
                    //WriteObject(this, false);
                    return result;
                } else {
//WriteVerbose(this, "000020");
...
//WriteVerbose(this, "000025");
                    foreach (string key in dict.Keys) {
//WriteVerbose(this, "000030");
