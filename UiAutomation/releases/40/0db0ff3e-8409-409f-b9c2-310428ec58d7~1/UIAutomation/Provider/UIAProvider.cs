...
namespace UIAutomation
{
    ...
    public class UIAProvider : ContainerCmdletProvider // DriveCmdletProvider // CmdletProvider
    {
//        public UIAProvider()
//        {
//        }
...
//                                                          ""));
            ...
            if (String.IsNullOrEmpty(drive.Root) && 
                ( (_element = ((cmd = new GetUIAWindowCommand())).GetWindow(cmd, drive.Root,
                                                                       drive.Root))
                                                         ==null))
...
//                                                         ==null))
            ...
            uIAPSDriveInfo = new UIADriveInfo(drive); // ????????????????
...
//        }
                            ...
                            PSDriveInfo drive) : base(drive)
        {
            ...
            GetUIAWindowCommand cmd;
            _window = 
            	((cmd = new GetUIAWindowCommand())).GetWindow(cmd, drive.Root,
                                                         "");
            if (_window!=null){
                // return _window;
                return;
            ...
            _window = 
            	((cmd = new GetUIAWindowCommand())).GetWindow(cmd, "",
                                                         drive.Root);
            // if (_window!=null){
            //    return _window;
            //}
