...
//                ((HasScriptBlockCmdletBase)cmdlet).OnErrorAction.Length>0){
        ...
        internal protected void RunEventScriptBlocks(HasControlInputCmdletBase cmdlet)
        {
            System.Collections.Generic.List<ScriptBlock> blocks =
                new System.Collections.Generic.List<ScriptBlock>();
//System.IO.StreamWriter writer = new System.IO.StreamWriter(@"c:\11evt11.txt", true);
//writer.WriteLine(blocks.Count.ToString() + " scriptblocks");
//writer.Flush();
            WriteVerbose(cmdlet,
...
//writer.WriteLine("EventAction!=null");
//writer.Flush();
...
//writer.WriteLine("runScriptBlocks " + blocks.Count.ToString() + " " + CmdletName(cmdlet));
//writer.Flush();
            runScriptBlocks(blocks, cmdlet, true);
//writer.WriteLine("after runScriptBlocks");
//writer.Flush();
//writer.Close();
