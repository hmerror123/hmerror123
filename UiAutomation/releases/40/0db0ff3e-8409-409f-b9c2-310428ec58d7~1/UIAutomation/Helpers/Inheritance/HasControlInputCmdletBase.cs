...
//           UIntPtr dwExtraInfo);
        ...
        internal protected AutomationEventHandler AutomationEventHandler { get; set; }
        internal protected AutomationPropertyChangedEventHandler AutomationPropertyChangedEventHandler { get; set; }
        internal protected StructureChangedEventHandler StructureChangedEventHandler { get; set; }
...
//            bool res2 = SendMessage1(handle, uUp, IntPtr.Zero, lParam);
        ...
        internal protected void SubscribeToEvents(HasControlInputCmdletBase cmdlet,
